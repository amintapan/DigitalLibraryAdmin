...
//        new ReturnBookActivity.ReturnAsyncTask().execute();
    ...
    class ReturnAsyncTask extends AsyncTask{
        ...
        protected void onPostExecute(Object o) {
            Toast.makeText(ReturnBookActivity.this, "Book Returned", Toast.LENGTH_SHORT).show();
            gotLibData=false;
            gotBookData=false;
            gotUserData=false;
            edt_user_id.setText("");
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if(dataSnapshot.child("bookUid").child("issuedBooks").child(bookUid).exists()){
                    ...
                    if(issuedTo.equals(userId)){
                        ...
                        Toast.makeText(ReturnBookActivity.this, "This Book is issued to " +issuedTo, Toast.LENGTH_SHORT).show();
                        progressDialog.cancel();
                    }
                    return;
                    ...
                    Toast.makeText(ReturnBookActivity.this, "This Book Was Not Issued", Toast.LENGTH_SHORT).show();
                    progressDialog.cancel();
                    return;
                }
                else {
...
*/
            ...
            public void onCancelled(DatabaseError databaseError) {
                ...
                Toast.makeText(ReturnBookActivity.this, "Unable to Fetch data at this time!!!", Toast.LENGTH_SHORT).show();
            }
        });
    }
/*
