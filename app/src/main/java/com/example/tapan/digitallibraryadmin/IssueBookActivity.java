...
public class IssueBookActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    String bookUid=null, librarianName=null, librarianUid=null, librarianId="786786";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edt_book_uid = (EditText) findViewById(R.id.edt_book_uid);
        btn_issue = (Button) findViewById(R.id.btn_issue);
        btn_user_qr = (Button) findViewById(R.id.btn_user_qr);
        btn_book_qr = (Button) findViewById(R.id.btn_book_qr);
...
//        bookDatabaseReference = firebaseDatabase.getReference().child("bookData").child("byou");
    ...
    private void checkAllThreeDone(boolean lib, boolean book, boolean user) {
        if(lib && book && user) {
            ...
            new IssueBookActivity.IssueAsyncTask().execute();
        }
    }
    ...
    * to set the data in firebase while issuing the book*/
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if(dataSnapshot.exists()) {
                    ...
                    if (dataSnapshot.child("bookUid").child("availableBooks").child(bookUid).exists()) {
                        ...
                        //obj_bookName.setValidBook(false);
                        gotBookData = false;
                        Toast.makeText(IssueBookActivity.this, "Book Not Valid", Toast.LENGTH_SHORT).show();
                        Log.d("validBook", "NO");
                        progressDialog.cancel();
                        return;
                    }
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if(dataSnapshot.exists()){
                    ...
                    if(dataSnapshot.child("issuedBooks").getChildrenCount()<=2 &&
                        ...
                        Toast.makeText(IssueBookActivity.this, "Already 2 Books Issued to " + userId, Toast.LENGTH_SHORT).show();
                        Log.d("validBook", "NO");
                        //obj_bookName.setValidBook(false);
                        gotUserData = false;
                        progressDialog.cancel();
    ...
    private void showAlert(){
        AlertDialog.Builder alertDialog = new AlertDialog.Builder(IssueBookActivity.this);
